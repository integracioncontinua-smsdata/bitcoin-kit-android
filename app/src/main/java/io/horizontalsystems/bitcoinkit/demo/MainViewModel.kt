...
class MainViewModel : ViewModel(), BitcoinKit.Listener {
    ...
    private val accessToken = "MoB4rSXfD53ZH4JKvEwhHwBFmu6GihQAgpRXArRSSSY3cNTt5HNkCph7vaMQCv2SD2nHG0b8tibexQR1"
    ...
    fun init() {
        ...
        bitcoinKit = BitcoinKit(App.instance, words, walletId, accessToken, networkType, syncMode = syncMode, bip = bip)
